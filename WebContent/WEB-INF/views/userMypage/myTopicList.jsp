						...
						<tr>
							...
							<td>
								<div class="sendAppList-btn">
									<button style="margin-right: 38%;" onclick="window.location='/cnav/topic/modifyForm.cnav?topNum=${item.topNum}'" />수정</button>
								</div>
							</td>
							<td>
								<div class="sendAppList-btn">
									<button style="margin-right: 38%;" onclick="deleteConfirm(${item.topNum})" />삭제</button>
								</div>
							</td>
						</tr>
						</c:forEach>
