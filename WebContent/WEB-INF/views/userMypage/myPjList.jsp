						...
						<tr>
							...
							<td>
								<div class="sendAppList-btn">
									<button style="margin-right: 29%;" onclick="window.location='/cnav/project/proModForm.cnav?proNum=${item.proNum}'" >수정</button>
								</div>
							</td>
							<td>
								<div class="sendAppList-btn">
									<button style="margin-right: 29%;" onclick="deleteConfirm(${item.proNum})" >삭제</button>
								</div>
							</td>
						</tr>
						</c:forEach>
